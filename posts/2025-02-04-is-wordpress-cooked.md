...
- A cyberpunk-themed landing page with animated gradient text
- A TV-style glitch animation that alternates between "MYBBOR" and "ROBBYM"
- Social media links with Font Awesome icons
- A QR code generator so I can show people this site from my phone
- A markdown-based blog system (you're reading it now)
- Rain and scanline effects for that retro CRT aesthetic
